...
import { Button, Chip, Label, PageSection } from '@patternfly/react-core';
    ...
    <CardBody>
      <DetailList>
        ...
        <Detail
          ...
          value={
            <StatusDetailValue>
              {job.status && <StatusCircle failed={job.status === 'failed'} />}
        ...
        {project && (
          <Detail
            ...
            value={
              <StatusDetailValue>
                {project.status && <StatusCircle failed={project.status === 'failed'} />}
      ...
      <CardActionsRow>
        ...
        {job.type !== 'system_job' &&
          job.summary_fields.user_capabilities.start && (
            <LaunchButton resource={job} aria-label={i18n._(t`Re-launch`)}>
              {({ handleRelaunch }) => (
