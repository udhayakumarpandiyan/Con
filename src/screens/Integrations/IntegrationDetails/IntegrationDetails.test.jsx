...
describe('<IntegrationDetails/>', () => {
  ...
  test('should mount properly', async () => {
    ...
    expect(wrapper.find('IntegrationDetails').length).toBe(1);
  });
  ...
  test('should delete properly', async () => {
    ...
    expect(IntegrationsAPI.destroy).toBeCalledWith(10);
  });

  test(' should not render delete button', async () => {
    integration.summary_fields.user_capabilities.delete = false;
    await act(async () => {
      wrapper = mountWithContexts(
        <IntegrationDetails
          integration={integration}
  ...
  test(' should not render edit button', async () => {
    integration.summary_fields.user_capabilities.edit = false;
    await act(async () => {
      wrapper = mountWithContexts(
        <IntegrationDetails
          integration={integration}
