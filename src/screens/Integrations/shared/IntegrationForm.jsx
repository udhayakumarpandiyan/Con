    ...
    <>
      ...
      <FormGroup
        ...
        labelIcon={
          <Popover
            content={i18n._(
              t`The Grant type the user must use for acquire tokens for this integration`
            )}
          />
        }
      >
...
function IntegrationForm({
  ...
  const initialValues = {
    ...
    organization: integration?.summary_fields?.organization || null,
    authorization_grant_type: integration?.authorization_grant_type || '',
...
export default withI18n()(IntegrationForm);
