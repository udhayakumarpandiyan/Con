...
import { deleteAwsHost } from "../../../actions/hostInventory/awsHostInventoryMain"
...
class HostDetails extends React.Component {
    ...
    async deleteAwsHost(hostInventoryId, clientId) {
        const { onCancel = () => { }, getList = () => { }, showLoaderIcon = () => { }, failureToast, successToast, catchBlock, deleteAwsHost, userId } = this.props;
        const { generateToken } = await this.props.generateToken();
        let request = { hostInventoryId, clientId, userId, apiToken: generateToken };
        showLoaderIcon(true);
        deleteAwsHost && deleteAwsHost(request)
            .then((res) => {
    ...
    actionButtons(hostInventoryId, clientId) {
        ...
        if (!isUnVerified) {
            return isAutoDiscovery ?
                ...
                :
                <button type="button" className='edit delete-icon' style={{ marginLeft: '10px' }} onClick={this.deleteAwsHost.bind(this, hostInventoryId, clientId)}>
        ...
        return <div>
            {
                ...
                <HostEditPage
                    ...
                    onCloseEditWindow={this.onCloseEditWindow}
    ...
    onCloseEditWindow = () => this.setState({ hasShowEdit: false });
    ...
    render() {
        ...
        return (
            <>
                ...
                {
                    !this.state.hasShowEdit && <>
                        <div className="aws-details modal-body">
                            <div className="row">
                            ...
                            <form onClick={e => e.preventDefault()} style={{ marginLeft: '10px', marginTop: '20px' }}>
                                <div className="row">
