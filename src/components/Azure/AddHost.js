...
class HostAddWizard extends Component {
    ...
    handleSubmit() {
        const { approver, autoStartStopSchedularPriority, availabilityZone, comments, description, diskInformation, env, fqdn, hostId, hostname, vmName,
            instanceDetails, isHostAutoSchedule, isProjectLinked, memory, numberOfCpu, os, primaryOwner, privateIp, projectId, publicIp, region, sandboxAccountId, secondaryOwner,
            serverType, startDate, startHour, status, stopDate, stopHour, tags, type, userList, resourceGroup, versionFlavor } = this.state;
        this.props.onSubmit && this.props.onSubmit({
            approver, autoStartStopSchedularPriority, availabilityZone, comments, description, diskInformation, env, fqdn, hostId, hostname, vmName,
            instanceDetails, isHostAutoSchedule, isProjectLinked, memory, numberOfCpu, os, primaryOwner, privateIp, projectId: projectId ? projectId : undefined, publicIp, region, sandboxAccountId: sandboxAccountId ? sandboxAccountId : undefined, secondaryOwner,
            serverType, startDate: startDate ? startDate : undefined, startHour: startHour ? startHour : undefined, status, stopDate: stopDate ? stopDate : undefined, stopHour: stopHour ? stopHour : undefined, tags, type, userList, resourceGroup, versionFlavor
        });
    }
    ...
    render() {
        ...
        const { diskInformation, memory, status, primaryOwner, secondaryOwner, privateKey, tags, numberOfCpu, availabilityZone, hostname, volumeExceptions, instanceDetails, comments, resourceGroup, vmName } = this.state;
        return (
            <React.Fragment>
                            ...
                            <form >
                                <div className="row pmm">
                                    ...
                                    <div className="form-group col-md-6">
                                        ...
                                        <select className="no-border modal-input-height bg-color-input aws-text-box" name="region" onChange={this.handleChange} >
                                            <option value="">Select</option>
                                            {
                                                ...
                                                this.props.getRegionAzure.map((data) =>
                                    ...
                                    <div className="form-group col-md-6">
                                        ...
                                        <input type="text" className="no-border modal-input-height bg-color-input aws-text-box"
                                            name="vmName" onChange={this.handleChange} value={vmName}
                                            onChange={this.handleChange} />
                                    </div>
                                    <div className="form-group col-md-6">
                                        <label className="col-form-label">Resource Group:</label>
                                        <input type="text" className="no-border modal-input-height bg-color-input aws-text-box"
                                            name="resourceGroup" onChange={this.handleChange} value={resourceGroup}
                                            onChange={this.handleChange} />
                                    </div>
                                    <div className="form-group col-md-6">
